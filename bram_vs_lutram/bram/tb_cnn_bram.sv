`timescale 1ns / 1ps
//============================================================================
// Testbench for 1D CNN — BRAM-Only Variant
//
...
module tb_cnn_bram;
    ...
    parameter SIM_DURATION_NS = 900000;  // Extra margin for BRAM pipeline latency
    ...
    task display_all_outputs;
        begin
            $display("============================================================");
            $display("  BRAM-ONLY CNN OUTPUT VALUES  (Q16.16 raw logits)");
            $display("============================================================");
    ...
    initial begin
        $display("\n============================================================");
        $display("  1D CNN TESTBENCH — BRAM-ONLY VARIANT");
        $display("  All weights/biases stored in Block RAM");
        $display("============================================================\n");
        ...
        $display("[INFO] All weights/biases loaded internally from BRAM ROM\n");
        ...
        $display("\n");
        $display("############################################################");
        $display("#      BRAM-ONLY CNN INFERENCE COMPLETE - RESULTS          #");
        $display("############################################################\n");
