`timescale 1ns / 1ps
//============================================================================
// Testbench for 1D CNN
//
// Architecture: Conv1(1→4,k5) → Pool(4) → Conv2(4→8,k3) → Pool(4)
//               → FC1(384→32) → FC2(32→10)
//
// Loads .mem files generated by cnn_model.py, runs inference, reports result.
//============================================================================
module tb_cnn;
    ...
    // Timing — conv layers dominate: 780×5 + 195×12 + 420 + 68 ≈ 7000 cycles
    ...
    localparam FC1_ENTRIES = FC1_WIDTH + 1;  // 424
    ...
    initial begin
        $display("\n============================================================");
        $display("  1D CNN TESTBENCH — LOADING DATA");
        $display("============================================================\n");
